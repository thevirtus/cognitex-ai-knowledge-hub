        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-lg font-bold text-foreground">Cognitex</span>
            </div>
            <p className="text-muted-foreground text-sm max-w-md">
              AI-powered team knowledge management platform that transforms your documents 
              into intelligent insights and collaborative intelligence.
            </p>
          </div>
        ...
        <div className="border-t border-border mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">
              © {currentYear} Cognitex. All rights reserved.
            </p>
